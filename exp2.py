...
output_xlsx = "lpgen_solver_times_pivot.xlsx"
...
for n in sizes:
    ...
    # Приведение к совместимым типам
    b = b.reshape(-1, 1)
    c = c.reshape(1, -1)
    x_lower = x_lower.reshape(-1, 1)
    x_upper = x_upper.reshape(-1, 1)

    # Задача ЛП: minimize cᵀx, subject to A x ≤ b, x_lower ≤ x ≤ x_upper
